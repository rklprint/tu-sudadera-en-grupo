...
export default function PrivacyPage() {
  return <LegalPage eyebrow="Privacidad" title="Política de privacidad" notice="Antes de publicar la web deben incorporarse la identidad, NIF y domicilio del responsable legal. Esta página permanece fuera del índice hasta entonces." sections={[
    { title: "Responsable y contacto", paragraphs: ["La marca comercial es Tu Sudadera en Grupo. La identidad fiscal del responsable del tratamiento está pendiente de incorporación. Para cuestiones de privacidad puede escribirse a info@tusudaderaengrupo.es."] },
