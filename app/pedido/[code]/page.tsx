  ...
  if (order.kind === "quote") {
    return <main className="flow-page private-order-page">
      ...
      <section className="quote-status-layout">
        ...
        <div className="status-board"><div className="status-board-top"><span>Estado actual</span><strong>Solicitud recibida</strong><i>En revisión</i></div><div className="status-order-summary"><p><span>Grupo</span><b>{order.groupName}</b></p><p><span>Modelo</span><b>{order.garment}</b></p><p><span>Color</span><b>{order.color}</b></p><p><span>Cantidad aproximada</span><b>{order.estimatedQuantity}</b></p></div><div className="status-steps"><div className="done"><i>✓</i><span><b>Solicitud registrada</b><small>Completado</small></span></div><div className="active"><i>02</i><span><b>Conversación y diseño</b><small>Revisión con el organizador</small></span></div><div><i>03</i><span><b>Propuesta aprobada</b><small>Diseño, cantidad y precio</small></span></div><div><i>04</i><span><b>Registro del grupo</b><small>Enlace privado automático</small></span></div></div><p className="status-contact">Contactaremos con el organizador por correo o WhatsApp para revisar la propuesta.</p></div>
      </section>
      <FlowFooter />
    </main>;
  }
