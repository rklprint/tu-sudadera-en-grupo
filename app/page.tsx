...
export default function Home() {
  ...
  const sleeveInMontage = Boolean(resolveSleeveFlag({ type: sleeveFlag, detail: sleeveDetail, technique: sleeveTechnique }) && sleevePlacement(activeProduct.slug, side === "front" ? selectedVariant?.frontImage : selectedVariant?.backImage, side));
  ...
  return <main className="homepage-flow">
    ...
    <section className="customizer-section" id="personalizador">
      <div className="section-heading dark-heading"><div><p className="eyebrow"><span /> Personalizador</p><h2>Personalizad vuestra prenda</h2></div></div>
    ...
    <section className="price-section price-section-linked" id="presupuesto">
      ...
      <div className="price-card">
        ...
        <details className="price-summary"><summary>Ver resumen y condiciones</summary><dl className="configuration-text-summary">
          ...
          <div><dt>Personalización</dt><dd>{backDesignLabel} + {frontDesignLabel}</dd></div>
