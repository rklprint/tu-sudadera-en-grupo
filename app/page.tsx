        ...
        <div className="product-selector-top">
          <div className="product-segmented-control" role="group" aria-label="Tipo de prenda">
            ...
            <button type="button" disabled={!categoryAvailable("tshirt")} className={productType === "tshirt" ? "active" : ""} aria-pressed={productType === "tshirt"} onClick={() => selectProduct("tshirt")}>
              <Shirt aria-hidden="true" />
              <span title="Modelo y tarifa por confirmar"><b>Camiseta</b><small>{tshirtProduct?.quoteOnly !== false ? "Por confirmar" : tshirtProduct.model}</small></span>
            </button>
          </div>
        </div>
            ...
            <details className="extras-details"><summary>Bandera o logo en manga <span>{sleeveFlag === "none" ? "Opcional" : sleeveDetail || selectedFlag}</span></summary>
              <div className="extras-body">
                ...
                {sleeveFlag !== "none" && <>
                  ...
                  <div className="sleeve-montage-link"><span>{sleeveInMontage ? "Bandera en manga · vista orientativa" : "El montaje se completa en la maqueta"}</span><a href="#vista-prenda">Ver montaje</a></div>
      ...
      <div className="price-card">
        ...
        <div className="price-live-result" aria-live="polite" aria-atomic="true">
          <div className={configuredUnitPrice === null ? "consult" : ""}>
            ...
            <strong>{configuredUnitPrice === null ? "Consultar" : <>{configuredUnitPrice} € <small>/ unidad</small></>}</strong>
        ...
        <p className="price-base-note">Precio base: {baseUnitPrice === null ? "Consultar" : `${baseUnitPrice} € / unidad`}{productType === "hoodie" && " · Sudadera + impresión en pecho + espalda + nombre"}</p>
        ...
        <details className="price-summary"><summary>Ver resumen y condiciones</summary><dl className="configuration-text-summary">
          ...
          <div><dt>Precio</dt><dd>{configuredUnitPrice === null ? "A consultar" : `${configuredUnitPrice} € / unidad`}</dd></div>
