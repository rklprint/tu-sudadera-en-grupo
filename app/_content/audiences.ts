...
export const audiencePages: Record<string, AudiencePageData> = {
  ...
  tshirts: {
    ...
    lead: "Gildan 2000 Ultra Cotton para vuestro grupo, desde 8 € por unidad para 76–99 prendas. IVA, DTF en pecho y espalda, nombre y envío conjunto a Península incluidos.",
    groupType: "Otro",
    ...
    intro: ["Elegid los mismos seis diseños disponibles para sudaderas, cambiad el color del estampado y añadid vuestro nombre al número o la X. Revisaremos juntos la maqueta antes de producir.", "Camiseta Gildan 2000 Ultra Cotton en nueve colores y tallas S–3XL. El personalizador calcula el precio según la cantidad; desde 100 unidades preparamos presupuesto."],
    benefits: [
      ...
      { title: "Presupuesto honesto", text: "Precios con IVA desde 15 € para 5–10 unidades hasta 8 € para 76–99. Desde 100, consultar." },
    ],
    ...
    faq: [
      { question: "¿Qué modelo de camiseta utilizáis?", answer: "Utilizamos Gildan 2000 Ultra Cotton, con guía de medidas en centímetros y tallas S–3XL en el catálogo. Confirmamos disponibilidad antes de producir." },
      { question: "¿Puedo solicitarla ya?", answer: "Sí, podéis enviar la idea y la cantidad; confirmaremos disponibilidad y precio final antes de cualquier pago." },
      { question: "¿Se pueden mezclar tallas?", answer: "Sí, cada persona elige su talla entre las disponibles del modelo Gildan 2000." },
